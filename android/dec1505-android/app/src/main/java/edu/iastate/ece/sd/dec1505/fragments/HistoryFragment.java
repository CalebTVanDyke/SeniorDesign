...
public class HistoryFragment extends ApplicationFragment implements Runnable{
    ...
    public void onInitialSetup(){
        ...
        Spinner spinner = (Spinner) findViewById(R.id.freq_choice_spinner);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(getContext(),
                R.array.hist_freq_choices, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner.setAdapter(adapter);

        TextView loadData = (TextView) findViewById(R.id.load_data_button);
        loadData.setOnClickListener(getLoadDataOnClick());
    ...
    private View.OnClickListener getLoadDataOnClick(){
    ...
    private String convertDataGap(String inString){
        String[] freqChoices = getResources().getStringArray(R.array.hist_freq_choices);
        if(inString.equals(freqChoices[0]))return "60";//one min
        else if(inString.equals(freqChoices[1]))return "300";//five mins
        else if(inString.equals(freqChoices[2]))return "600";//ten mins
        else if(inString.equals(freqChoices[3]))return "1800";//thirty mins
        else if(inString.equals(freqChoices[4]))return "3600";//sixty mins
        return "0";
    }
    ...
    public static class TimePickerFragment extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            try {
                Date thisTime = twntyFourHrFrmt.parse(hourOfDay+":"+minute);
                Log.e("", "");
